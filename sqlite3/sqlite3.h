...
** both their own internal Database Tools and also databases that are controlled
...
** rather the symbolic name of the Database Tools. For attached databases, this is
...
** Database Tools file in rollback mode databases. Any pages written as part of
...
** belonging to the next (if any) Database Tools. ^If any databases are skipped
